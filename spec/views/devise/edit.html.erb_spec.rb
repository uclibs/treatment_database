# copied in whole from ucrate.  This will need to be adjusted to fit our application.

# frozen_string_literal: true

require 'rails_helper'
# Skipping this because we don't have a devise/registrations/edit.html.erb file.
# And we will be removing Devise from our application.

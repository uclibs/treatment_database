...
RSpec.describe User, type: :model do
  it 'is valid when all required fields are provided' do
    user = User.new(email: 'test@uc.edu', password: 'notapassword', display_name: 'Bobby Tables')
    expect(user).to be_valid
  end

  it 'is not valid without a display name' do
    user = User.new(email: 'test@uc.edu', password: 'notapassword')
  ...
  it 'is not valid without a password' do
    user = User.new(email: 'test@uc.edu', display_name: 'Bobby Tables')
    expect(user).to_not be_valid
  end

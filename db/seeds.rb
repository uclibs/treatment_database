...
class AddSeedObjects < ActiveRecord::Migration[5.1]
  ...
  ConservationRecord.create(
    [
      {
        date_recieved_in_preservation_services: Time.zone.now,
      ...
      {
        date_recieved_in_preservation_services: Time.zone.now - 1.day,
        department: ControlledVocabulary.where(vocabulary: "department").sample(1).first.id,
        title: 'Ulysses',
        author: 'James Joyce',
        imprint: 'Picador',
      ...
      {
        date_recieved_in_preservation_services: Time.zone.now - 2.days,
        department: ControlledVocabulary.where(vocabulary: "department").sample(1).first.id,
